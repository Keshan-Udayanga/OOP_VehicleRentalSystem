...
<body>
	...
	<form action = "DriverDeleteServlet" method = "post">
		...
		<table>
			...
			<tr>
				<td>Phone No : </td>
				<td><input type = "text" name = "phone" value = "<%=phoneNo%>" readonly></td>
			</tr>
			<tr>
				<td>Address : </td>
			...
			<tr>
				<td>License No : </td>
				<td><input type = "text" name = "licenseNo" value = "<%=licenNo%>" readonly></td>
			</tr>
			<tr>
				<td>License Expire Date : </td>
				<td><input type = "date" name = "licenseExp" value = "<%=licenExp%>" readonly></td>
			</tr>
			<tr>
				<td>Vehicle Type : </td>
				<td><select name = "vType" onchange="this.selectedIndex = 0">
			...
			<input type = "submit" name = "sub" value = "Delete My Account">	
			</td></tr>																								
		</table>
	</form>	
